...
function btnEncodeClick() {
    document.getElementById('result').value = window.base64.encode(document.getElementById('source').value);
}

function btnDecodeClick() {
    document.getElementById('result').value = window.base64.decode(document.getElementById('source').value);
}